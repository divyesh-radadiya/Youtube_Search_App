...
import 'package:youtube_search_app/ui/detail/bloc/detail_bloc.dart';
import 'package:kiwi/kiwi.dart' as kiwi;
import 'package:youtube_search_app/ui/search/components/centered_message.dart';
import 'package:youtube_search_app/data/model/detail/video_snippet.dart';
...
class _DetailPageState extends State<DetailPage> {
  ...
  void initState() {
    super.initState();
    _detailBloc.add(ShowDetail(widget.videoId));
  }
